...
describe('wire tests', () => {
    it('power loss is calculated fine, Example 9.11', () => {
        ...
        expect(wire.shortImpedance(false).toFixed(4)).toEqual('0.3132');
        expect(wire.powerLoss(113.64).toFixed(4)).toEqual('4044.6803');
    });
    ...
    it('impedance is calculated fine - Markowicz page 50', () => {
        ...
        expect(wire.shortImpedance(false).toFixed(4)).toEqual('0.0698');
    });
});